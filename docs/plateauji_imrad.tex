...
Po označitvi mej se nad preostalimi celicami izvede barvanje povezanih komponent. Vsaka nepobarvana celica, ki ni meja, se uporabi kot seme novega bazena. Algoritem nato razširi trenutno barvo po povezanem območju, dokler ne doseže mejnih celic. Ta del ostaja enak kot prejšnja implementacija.
...
Metoda za računanje atrakcijskih bazenov je nadgrajena, da prepozna tudi platoje. Meje med bazeni se še vedno določijo pred barvanjem, dodatni pogoji pri iskanju meja pa omogočijo, da se upoštevajo tudi prehodi v ravna območja. Zaznavanje platojev je izvedeno po barvanju bazenov, zato lahko sistem za vsako celico hrani tako informacijo o bazenu kot informacijo o platoju.
...
\begin{itemize}
    ...
    \item Lahko uvedbo toleranco za primerjavo vrednosti funkcije kot je opisano v prejšnjem poglavju
